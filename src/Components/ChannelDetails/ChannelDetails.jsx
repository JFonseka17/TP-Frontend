...
const ChannelDetails = () => {
    ...
    // Actualizar lista local cuando cambia la respuesta del hook
    useEffect(() => {
    ...
    // Handler para borrar un mensaje (aparece junto a cada mensaje)
                        ...
                        <ul className="messages-list" aria-live="polite">
                            {messagesList.map(m => (
                                <li key={m._id} className="message-row">
                                    ...
                                    {/* Botón de borrar (SVG simple, sin estilos) */}
                                    <button
