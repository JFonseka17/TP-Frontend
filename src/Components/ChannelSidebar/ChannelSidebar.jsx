            ...
            <div className='channel-sidebar-left'>
                ...
                <div className='channel-sidebar-footer'>
                    <div className="sidebar-logout">
                        <button className="sidebar-icon" aria-label="Logout">
